...
$endpoint = azd env get-value VLLM_PROXY_ENDPOINT 2>$null
$model = azd env get-value SERVED_MODEL_NAME 2>$null
...
Write-Host ""
Write-Host "  vLLM serves via continuous batching, so concurrent requests are handled natively."
Write-Host ""
